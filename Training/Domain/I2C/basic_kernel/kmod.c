...
/* GLobal variables */
char *devname = "sample" ;	//contains device name
int majNo;	
...
//	struct task_struct *ptr = find_task_by_vpid(a);
	struct module *str = THIS_MODULE;
			

	printk(KERN_INFO "Name of module %s:\n", str -> name);
	printk(KERN_INFO "In IOCTL:\n");
	printk(KERN_INFO "Pointer From CURRENT %d:\n", ptr -> pid); 
